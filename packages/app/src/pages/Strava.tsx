...
export function StravaPage() {
	...
	const loadCloudStatus = useCallback(async () => {
		...
		setGlobalLoading(true, "Checking cloud session");
	...
	}, [client, isDesktop, setGlobalLoading]);
	...
	const loadSubscriptions = useCallback(async () => {
		...
		console.log("Strava subscriptions page result", result);
		if (result.success) {
					...
					<>
						<SectionContainer hasBorder>
							<div className="space-y-3">
								...
								<div
									className={cn(skeletonClassName, "h-4 w-full max-w-2xl")}
								/>
